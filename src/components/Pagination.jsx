...
console.log({
  ...
  <button
    ...
    border border-[#FF5A5A]/40 text-[#FF5A5A] disabled:opacity-40
  ...
  {visiblePages[0] > 1 && (
    <>
      <button
        ...
        className="px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-md sm:rounded-xl
        border border-[#FF5A5A]/40 text-[#FF5A5A] hover:bg-red-50 transition font-medium"
      >
        1
      </button>
  ...
  {visiblePages.map((page) => (
    <button
      ...
      className={`px-2 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm rounded-md sm:rounded-xl font-semibold transition
        ${
          currentPage === page
            ? "bg-gradient-to-r from-[#FF5A5A] to-[#FF3B3B] text-white shadow-lg"
            : "border border-[#FF5A5A]/40 text-[#FF5A5A] hover:bg-red-50"
        }`}
    >
      {page}
    </button>
